...
don't-trust-a-single-witness pattern `scripts/test/run_nic_test.sh` established),
...
checks the response bytes -- `scripts/test/run_tcp_test.sh` drives the other side of
